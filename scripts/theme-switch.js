...
themeSwitchBttn.forEach(button => {
  ...
  document.querySelector('.pagination__button_left').classList.toggle('pagination__button_left_theme_dark')
  document.querySelector('.pagination__button_right').classList.toggle('pagination__button_right_theme_dark')
